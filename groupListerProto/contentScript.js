(function($) {
    ...
    var createPopup = {
        fn: {
            insert: function() {
                $('#facebook').prepend('<link href="https://fonts.googleapis.com/css?family=Open+Sans:300" rel="stylesheet" type="text/css"><div class="popupMinified"><a class="open">Open</a></div><div class="popupMain"></div>');
